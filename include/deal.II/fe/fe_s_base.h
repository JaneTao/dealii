...
#ifndef __deal2__fe_s_base_h
#define __deal2__fe_s_base_h
...
class FE_S_Base : public FE_Poly<POLY,dim,spacedim>
{
public:
  /**
   * Constructor.
   */
  FE_S_Base (const POLY &poly_space,
...
protected:
   ...
   */
  friend struct FE_S_Base<POLY,dim,spacedim>::Implementation;
