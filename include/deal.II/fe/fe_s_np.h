...
#ifndef __deal2__fe_s_np_h
#define __deal2__fe_s_np_h
...
class FE_S_NP : public FE_S_NP_Base<SerendipityPolynomials<dim>,dim,spacedim>
{
public:
  /**
   * Constructor for tensor product polynomials of degree @p p.
   */
  FE_S_NP (const unsigned int p);
