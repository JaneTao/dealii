...
FE_S_NP<dim,spacedim>::FE_S_NP (const unsigned int degree)
  :
  FE_S_NP_Base<SerendipityPolynomials<dim>, dim, spacedim> (
...
template <int dim, int spacedim>
std::string
FE_S_NP<dim,spacedim>::get_name () const
{
...
FE_S_NP<dim,spacedim>::clone() const
{
  return new FE_S_NP<dim,spacedim>(*this);
}


// explicit instantiations
#include "fe_s_np.inst"
